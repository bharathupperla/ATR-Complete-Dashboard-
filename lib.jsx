...
const PORTFOLIO = {
  ...
  atrHistory: (function () {
    ...
    for (let i = 0; i < 26; i++) {
      ...
      w.push({ week: `W${i + 1}`, atr1W: +v1.toFixed(2), atr1M: +v2.toFixed(2) });
    }
    return w;
  })(),
  returnHistory: (function () {
    ...
    const r = () => { x = (x * 9301 + 49297) % 233280; return x / 233280; };
    for (let i = 0; i < 26; i++) {
      const target = (24.18 / 25) * i;
      const noise = (r() - 0.5) * 3.4;
      cum = +(target + noise).toFixed(2);
      w.push({ week: `W${i + 1}`, idx: i, ret: cum });
    }
    w[w.length - 1].ret = 24.18;
    return w;
  })(),
